			...
			<div class="col-md-8">
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<form action="{{route('forpost')}}" method="POST" enctype="multipart/form-data">
							@csrf
							...
							<div class="form-group">
								...
								<select name="category_name" class="form-control">
									...
									<option value="{{$categories->id}}" {{$categories->id==old('category_name')?'selected':null}}>{{$categories->name}}</option>
									@endforeach
								</select>
									@error('category_name')
